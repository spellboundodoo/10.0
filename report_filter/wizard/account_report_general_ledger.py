...
#             'account.analytic.account','account_report_general_ledger_accounts_analytic_rel', 'account_id', 'analytic_id',
#             string='Filter on Accounts')
#     analytic_show = fields.Boolean('Display Analytic Columns')
